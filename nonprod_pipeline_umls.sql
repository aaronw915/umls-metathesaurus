CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRCONSO (
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRDEF (
    CUI       STRING COMMENT 'Concept Unique Identifier',
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRDOC (
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRHIER (
    CUI     STRING COMMENT 'Concept Unique Identifier',
    AUI     STRING COMMENT 'Atom Unique Identifier',
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRRANK (
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRREL (
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRSAB (
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRSAT (
...
CREATE OR REPLACE TABLE IOP_10005270.HEALTHCARE.MRSTY (
    CUI      STRING COMMENT 'Concept Unique Identifier',
...
COPY INTO MRCONSO
FROM @IOP_10005270.HEALTHCARE.UMLS_STAGE/MRCONSO.RRF
...
COPY INTO MRREL
FROM @IOP_10005270.HEALTHCARE.UMLS_STAGE/MRREL.RRF
FILE_FORMAT = (FORMAT_NAME='IOP_10005270.HEALTHCARE.UMLS_RRF_FORMAT');
...
COPY INTO MRSAT
FROM @IOP_10005270.HEALTHCARE.UMLS_STAGE/MRSAT.RRF
FILE_FORMAT = (FORMAT_NAME='IOP_10005270.HEALTHCARE.UMLS_RRF_FORMAT');
